...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        for i, f in enumerate(use_folds):
            ...
            checkpoint = torch.load(join(model_training_output_dir, 'fold_all', 'checkpoint_best.pth'),
                                    map_location=torch.device('cpu'))
            if i == 0:
    ...
    def predict_from_data_iterator(self,
        ...
        with multiprocessing.get_context("spawn").Pool(num_processes_segmentation_export) as export_pool:
            ...
            for preprocessed in data_iterator:
                ...
                # data = F.interpolate(data.transpose(1, 2), size=504, mode='linear').transpose(1, 2)
    ...
    def predict_logits_from_preprocessed_data(self, data: torch.Tensor) -> torch.Tensor:
        ...
        with torch.no_grad():
            ...
            for params in self.list_of_parameters:
                ...
                # if 'vit.patch_embedding.position_embeddings' in params:
                #     pretrained_weight = params['vit.patch_embedding.position_embeddings']
                #     adjusted_weight = F.interpolate(pretrained_weight.transpose(1, 2), size=420, mode='linear').transpose(1, 2)
                #     params['vit.patch_embedding.position_embeddings'] = adjusted_weight
    ...
    def _internal_predict_sliding_window_return_logits(self,
        ...
        for sl in tqdm(slicers, disable=not self.allow_tqdm):
            ...
            #workon = workon.expand(-1, 2, -1, -1, -1)
            #print(workon.shape)
            #print('****************')
