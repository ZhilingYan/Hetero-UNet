...
class nnUNetTrainer(object):
    ...
    def initialize(self):
        ...
        para_num = sum([p.numel() for p in self.network.parameters()])
        para_size = para_num * 4 / 1024 / 1024

        print("Model_size: {}".format(para_size))
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        if self.grad_scaler is not None:
            ...
            torch.nn.utils.clip_grad_norm_(self.network.parameters(), max_norm=1.0, norm_type=2)
    ...
    def on_epoch_end(self):
        ...
        if self._best_ema is None or self.logger.my_fantastic_logging['ema_fg_dice'][-1] > self._best_ema:
            ...
            wandb.log({'best_ema_fg_dice': self._best_ema}, step=current_epoch)
