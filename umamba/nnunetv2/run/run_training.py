...
def set_random_seeds(seed_value=1234):
...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    seed_value=1234             
    set_random_seeds(seed_value=seed_value) 
    print("random_seeds: ", seed_value)
...
def run_training_entry():
    ...
    parser.add_argument('--note', type=str, default=None, required=False, help='[OPTIONAL] Add a note to the run')
    ...
    wandb.init(project="umamba", config=args, entity="mib-nlp")
